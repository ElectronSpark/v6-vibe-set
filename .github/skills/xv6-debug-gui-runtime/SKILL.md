...
- When rebuilding WebKit from `xv6-tmp`, the CMake build may need host GLib tools on `PATH`. If it fails at `glib-compile-resources`, rerun with `PATH=/home/es/xv6/xv6-tmp/build-x86/gtk-stack/host-tools:/home/es/xv6/xv6-tmp/build-x86/gtk-stack/host-glib/gio:$PATH cmake --build /home/es/xv6/xv6-tmp/build-x86/webkit-stack/webkitgtk -j$(nproc)`, then run `cmake --install /home/es/xv6/xv6-tmp/build-x86/webkit-stack/webkitgtk` without an extra `DESTDIR`.
