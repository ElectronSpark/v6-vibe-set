...
description: Redirect only. Use the authoritative repo skill at .github/skills/xv6-os-debugging/SKILL.md for QEMU, kernel symbols, GUI/Wayland ports, Linux GUI ABI/X11/Chromium stress, NetSurf, OpenSSL/OpenSSH, rootfs images, or nested submodule workflows.
metadata:
  short-description: Redirect to .github xv6 skill
---

# xv6-os Debugging Redirect

The real skill files for this repo live in `.github/skills`.

- Read `.github/skills/xv6-os-debugging/SKILL.md`.
